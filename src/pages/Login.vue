      ...
      <div  class="loginArea">
        ...
        >
          ...
          <div v-show="isShow" class="btnArea">
            <el-button type="success" size = "medium" round style="background-color: #d09057; border: 1px solid #ffffff;" @click="UserLogin"  >登&nbsp;&nbsp;&nbsp;录</el-button>
          </div>
        </transition>
      </div>
      <!-- 注册表单 -->
      <div class="registArea">
        ...
        >
          ...
          <div  v-show="!isShow" class="registBtn">
            <el-button type="success" size = "medium" round style="background-color: #d09057;border: 1px solid #ffffff;" @click="userRegister">注&nbsp;&nbsp;&nbsp;册</el-button>
          </div>
        </transition>
      </div>
      <!-- 信息展示界面 -->
      <div id="aaa" class="showInfo"
        ...
        >
          ...
          <div v-show="isShow" style="display: flex;flex-direction: column;align-items: center;justify-content: center;width: 100%;height: 100%">
            ...
            <!-- 欢迎图片 -->
            <div style="flex: 2">
              <el-button type="success"  style="background-color:#d09057;border: 1px solid #ffffff;" round @click="changeToRegiest">还没有账户？点击注册</el-button>
            </div>
          </div>
        </transition>
        <!-- 用户输入用户名时展示头像以及姓名 -->
        ...
        >
          ...
          <div v-show="!isShow" style="display: flex;flex-direction: column;align-items: center;justify-content: center;width: 100%;height: 100%">
            ...
            <!-- 欢迎图片 -->
            <div style="flex: 2">
              <el-button type="success"  style="background-color:#d09057;border: 1px solid #ffffff;" round @click="changeToLogin">已有账户？点击登录</el-button>
            </div>
          </div>
        </transition>
      </div>
...
.title{
  width: 70%;
  flex:1;
  border-bottom: 1px solid #d09057;
  display: flex;
  align-items: center;
  color: #d09057;
  font-weight: bold;
